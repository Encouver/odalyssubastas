...
/*
	...
	Yii::app()->clientScript->registerScript('quicksearch','$(document).ready(function(){
																...
																$("div#barraBusqueda").empty().html(\'<input id="autorBusqueda" onkeyup="\'+barinput+\'" oninput="\'+barinput+\'" placeholder="Búsqueda por artista" style="padding:0.5em !important; width:100% !important;"/>\');
